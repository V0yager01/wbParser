...
#Эндпоинты каталога для "пальто из натуральной шерсти" 
...
#Произвольное количество страниц
PAGE_COUNT = 50
...
#Доступные баскеты, где может быть эндпоинт для получения json карточки 
working_basket_list = [
